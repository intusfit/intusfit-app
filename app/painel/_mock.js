...
const ICONS = {
  ...
  video:    `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><rect x="3" y="6" width="13" height="12" rx="2"/><path stroke-linecap="round" stroke-linejoin="round" d="M16 10.5l5-3v9l-5-3"/><circle cx="9.5" cy="12" r="2" fill="currentColor" stroke="none"/></svg>`,
  camera:   `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 9a2 2 0 012-2h1.5l1-1.5h9l1 1.5H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/><circle cx="12" cy="13" r="3.5"/></svg>`,
...
function renderLayout(activePage) {
  ...
  const nav = [
    ...
    { href: '../../relatorios-fotos/', icon: ICONS.camera, label: 'Relatório de Fotos', show: true },
    { href: '../../feedback-video/', icon: ICONS.video, label: 'Feedback em Vídeo', show: true },
