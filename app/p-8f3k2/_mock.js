...
const MOCK = {
  ...
  dashboard: {
    ...
    mensalidades_vencidas: [
      { nome: 'Jaqueline Grigio',            dtvenc: '31/05/2025', professor: 'Ana K.' },
      { nome: 'Jéssica de Souza da Silva',   dtvenc: '31/05/2025', professor: 'Griebe' },
      { nome: 'Adelson Luiz Correia',        dtvenc: '31/05/2025', professor: 'Ana' },
      { nome: 'Anderson Haas',               dtvenc: '31/05/2025', professor: '' },
      { nome: 'Carla Bruch',                 dtvenc: '31/05/2025', professor: '' },
      { nome: 'Ana Paula Schuur',            dtvenc: '31/05/2025', professor: '' },
      { nome: 'Maykon Rissi',                dtvenc: '31/05/2025', professor: '' },
      { nome: 'Meliany Cristina da Silva',   dtvenc: '31/05/2025', professor: '' },
      { nome: 'Lucia Bethania de Oliveira',  dtvenc: '31/05/2025', professor: '' },
      { nome: 'Erick Braz',                  dtvenc: '31/05/2025', professor: '' },
      { nome: 'Michael Cristian Zatta',      dtvenc: '31/05/2025', professor: '' },
      { nome: 'Fabio Baldini Menegueti',     dtvenc: '31/05/2025', professor: '' },
      { nome: 'Samantha Lara',               dtvenc: '30/05/2025', professor: '' },
      { nome: 'Ricardo Schmoeller',          dtvenc: '29/05/2025', professor: '' },
    ],
  },
...
function _permsAllTrue() {
  const o = {};
  PERM_KEYS.forEach(p => o[p.key] = true);
  return o;
}
...
const Atletas = {
  ...
  criarAutoCadastro(dados) {
    ...
    const nextId = (lista.reduce((m,a)=>Math.max(m, a.idatleta||0), 0) + 1) || 1;
    const novo = {
      idatleta:     nextId,
      nome:         String(dados.nome||'').trim(),
      email:        e,
...
function renderLayout(activePage) {
  ...
  const nav = [
    ...
    { href: 'frequencia.html',   icon: ICONS.frequency,label: 'Frequência',   show: true },
    ...
    { href: 'mensagens.html',    icon: ICONS.chat,     label: 'Mensagens',    show: true },
